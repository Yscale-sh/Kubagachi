...
const ADD_GROUPS: { label: string; kinds: TabKind[] }[] = [
  { label: "General", kinds: ["overview", "events", "search", "kubagachi"] },
  {
    label: "Workloads",
            ...
            >
              ...
              {canClose && (
                <button
                  ...
                  className={
                    "ml-1 inline-flex items-center justify-center h-4 w-4 text-text-muted hover:bg-bg-panel2 hover:text-text transition-colors duration-100 k9s-square " +
