...
Deploy [kubagachi](https://github.com/JakeNesler/Kubagachi) — a
...
> hardcoded — the artifacts are `ghcr.io/jakenesler/kubagachi` (image) and
> `ghcr.io/jakenesler/charts/kubagachi` (chart).
...
helm install kubagachi oci://ghcr.io/jakenesler/charts/kubagachi \
...
helm install demo oci://ghcr.io/jakenesler/charts/kubagachi \
...
| `image.repository` | `ghcr.io/jakenesler/kubagachi` | Image repository (CI stamps this to `ghcr.io/<owner>/<repo>` at publish). |
